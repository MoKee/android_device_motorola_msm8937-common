...
public class FlipToMute implements UpdatedStateNotifier {
    private static final String TAG = "MoKeeActions-FlipToMute";
    ...
    public FlipToMute(MoKeeActionsSettings mokeeActionsSettings, Context context,
    ...
    public void updateState() {
        if (mMoKeeActionsSettings.isFlipToMuteEnabled() && !mIsEnabled) {
            Log.d(TAG, "Enabling");
            ...
            mIsEnabled = true;
        } else if (!mMoKeeActionsSettings.isFlipToMuteEnabled() && mIsEnabled) {
            Log.d(TAG, "Disabling");
